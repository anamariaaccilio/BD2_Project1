...
void savekey(string key, string tabla){
    ofstream archivo("/Users/diegopachecoferrel/Documents/AED/BD2/tablekeys.txt");
...
string findKeyForTable(const string& tableName) {
    std::ifstream archivo("/Users/diegopachecoferrel/Documents/AED/BD2/tablekeys.txt");
